...
def compute_daily_k_props():
    ...
    # Separate lists for each hot list
    hits_qualifiers = []
    ...
    for game in today_games:
        ...
        for player_id, full_name, team_abbrev in batter_list:
            ...
            # Add to the correct hot list(s) — a player can appear in more than one if they qualify for multiple
            qualified = False
    ...
    print(f"\nFile: daily_k_props.json is ready for the app!")
